...
print(results.shape)
cv.imwrite("result0_0.png", results[0,...,0])
cv.imwrite("result0_1.png", results[0,...,1])
cv.imwrite("result0_2.png", results[0,...,2])
cv.imwrite("result0_3.png", results[0,...,3])
cv.imwrite("result0_4.png", results[0,...,4])
