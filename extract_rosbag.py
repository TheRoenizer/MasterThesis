...
with rosbag.Bag(path) as bag:
    ...
    for i in range(35, 1370, 20):
        ...
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/cool2/img{}_left.png".format(int((i-35)/20)), img_left)
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/cool2/img{}_right.png".format(int((i-35)/20)), img_right)
