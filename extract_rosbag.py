...
with rosbag.Bag(path) as bag:
    ...
    f = open("/home/jsteeen/Pictures/rosbag_pictures/grasp1/poses.txt", "w+")
    ...
    for i in range(1, 419, 5):
        ...
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/grasp1/img{}_left.png".format(int(i/10)), img_left)
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/grasp1/img{}_right.png".format(int(i/10)), img_right)
