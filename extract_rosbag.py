...
with rosbag.Bag(path) as bag:
    ...
    for i in range(120, 264, 2):
        ...
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/img{}_left.png".format(int((i-120)/2)), img_left)
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/img{}_right.png".format(int((i-120)/2)), img_right)
...
poses = np.load("/home/jsteeen/Pictures/rosbag_pictures/pose_arr.npy")
                 /home/jsteeen/Pictures/rosbag_pictures/pose_arr.npy
