...
with rosbag.Bag(path) as bag:
    ...
    for i in range(0, 419, 6):
        ...
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/grasp1/img{}_left.png".format(int((i)/6)), img_left)
        cv.imwrite("/home/jsteeen/Pictures/rosbag_pictures/grasp1/img{}_right.png".format(int((i)/6)), img_right)
